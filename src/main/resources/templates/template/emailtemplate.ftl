...
<div class="qmbox qm_con_body_content qqmail_webmail_only" id="mailContentContainer" style="">
    ...
    <div class="contaner">
        <div class="title">IT模块</div>
        <div class="content">
            <p class="biaoti"><b>亲爱的用户，你好！</b></p>
            <b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
            <div class="xboxcontent">
                <div class="neirong">
                    <p><b>欢迎注册IT模块</b><#--<span id="userName" class="font_darkblue">$(userName)</span>--></p>
                    <p><b>验证码：</b><span class="font_lightblue"><span id="yzm" data="${captcha}" onclick="return false;"
                                                                     t="7"
                                                                     style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;">${captcha}</span></span><br><span
                            class="font_gray">(请在注册页面输入该验证码，验证码3分钟内有效！)</span></p>
                    <div class="line">如果你未申请IT模块服务，请忽略该邮件。</div>
                </div>
            </div>
            <b class="xbottom"><b class="xb4"></b><b class="xb3"></b><b class="xb2"></b><b class="xb1"></b></b>
            <p class="foot">如果仍有问题，请登录我们网站反馈: <span onclick="return false;" t="7"
                                                    style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;"><a href="www.itmodul.com" target="_blank">www.itmodul.com</a>
</span></p>
        </div>
    </div>
    <style type="text/css">
